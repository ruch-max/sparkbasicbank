...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2"></div>
				<h2> km Ruchi Pandey</h2>
				<!--img id="image2" src="C:\ruchi\Desktop\r.jpg" align="left"-->
				    

			    <p> My name is Ruchi Pandey, I am currently a 3rd-year Electronic and Communication Engineering student at Madan Mohan Malaviya University of Technology GKP . I am currently a localite at Gorakhpur UP

			
			<br>My passion is in Web Development,I have done some courses on programming languages like python and javascript, web development tools like HTML and CSS.Looking for an
